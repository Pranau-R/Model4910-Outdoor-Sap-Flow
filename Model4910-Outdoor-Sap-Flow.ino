...
Module: Model4910-Outdoor-Sap-Flow.ino

Function:
        Code for the Model4910-Outdoor-Sap-Flow using Catena 4801
...
cMeasurementLoop gMeasurementLoop { gLtr };
...
void setup()
    ...
    setup_commands();
    setup_start();
    gMeasurementLoop.setupInterrupts();
    }
